...
# app.conf.worker_concurrency = 10  # Set it to a value higher than the number of tasks
app.conf.worker_concurrency = 10  # Set it to a value higher than the number of tasks
...
# Create a list of signature objects for the video_chunk_downloader tasks
    ...
    # Use a Celery group to run the video_chunk_downloader tasks in parallel
    result = group(task_signatures)()
    return result
